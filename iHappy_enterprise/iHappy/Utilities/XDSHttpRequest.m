...
- (void)GETWithURLString:(NSString *)urlString
    ...
    [self requestWithURLString:urlString reqParam:reqParam method:@"GET" hudController:hudController showHUD:showHUD HUDText:HUDText showFailedHUD:showFailedHUD success:success failed:failed];
}
- (void)POSTWithURLString:(NSString *)urlString
           ...
           showFailedHUD:(BOOL)showFailedHUD
                 success:(void(^)(BOOL success,  id successResult))success
                  failed:(void(^)(NSString * errorDescription))failed{
    [self requestWithURLString:urlString reqParam:reqParam method:@"POST" hudController:hudController showHUD:showHUD HUDText:HUDText showFailedHUD:showFailedHUD success:success failed:failed];
}
