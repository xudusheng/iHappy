...
- (BOOL)isSymbol {
    return _type == NLEBNFTokenType_SYMBOL;
}

- (BOOL)isWord {
    return _type == NLEBNFTokenType_WORD;
}

- (BOOL)isQuotedString {
    return _type == NLEBNFTokenType_QUOTED_STRING;
}

- (BOOL)isNumber {
    return _type == NLEBNFTokenType_NUMBER;
}

- (BOOL)isComment {
    return _type == NLEBNFTokenType_COMMENT;
}

- (BOOL)isWhitespace {
    return _type == NLEBNFTokenType_WHITESPACE;
}
